...
public class Home extends JFrame implements ActionListener{
	...
	public Home() {
		...
		mnitemLogout.setBackground(new Color(211, 211, 211));
		mnitemLogout.setForeground(new Color(105, 105, 105));
		mnitemLogout.addActionListener(this);
		mnExit.add(mnitemLogout);
		
		JMenuItem mnitemExit = new JMenuItem("Exit");
		mnitemLogout.setBackground(new Color(211, 211, 211));
		mnitemLogout.setForeground(new Color(105, 105, 105));
		mnitemLogout.addActionListener(this); 	
		mnExit.add(mnitemExit);
		
		JMenu mnHelp = new JMenu("Help");
		mnHelp.setFont(new Font("Trebuchet MS", Font.BOLD, 17));
		
		JMenuItem mnitemReadme = new JMenuItem("Read Me");
		mnitemReadme.setBackground(new Color(211, 211, 211));
		mnitemReadme.setForeground(new Color(105, 105, 105));
		mnHelp.add(mnitemReadme);
		
		JMenuItem mnitemAboutus = new JMenuItem("About Us");
		mnitemAboutus.setBackground(new Color(211, 211, 211));
		mnitemAboutus.setForeground(new Color(105, 105, 105));
		mnitemAboutus.addActionListener(this);
		mnHelp.add(mnitemAboutus);
		
		JMenu mnRecord = new JMenu("Record");
		mnRecord.setFont(new Font("Trebuchet MS", Font.BOLD,17 ));
		
		
		JMenuItem mnitemdetails = new JMenuItem("Book Details");
		mnitemdetails.setBackground(new Color(211, 211, 211));
		mnitemdetails.setForeground(Color.DARK_GRAY);
		mnitemdetails.addActionListener(this);
		mnRecord.add(mnitemdetails);
		...
		JLabel l1 = new JLabel("Libray Management System");
		...
		panel2.setBorder(new TitledBorder(new LineBorder(new Color(205, 133, 63),2), "Action",TitledBorder.LEADING,
						TitledBorder.TOP,null, new Color(223, 150, 122)));
	...
	public void actionPerformed(ActionEvent ae) {
		...
		else if(msg.contentEquals("Student Details")) {
			setVisible(false);
